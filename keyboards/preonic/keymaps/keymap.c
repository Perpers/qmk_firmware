...
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    NO_AE,   NO_OSLH, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   NO_ENT,  \
  KC_LCTL, KC_LGUI, KC_LESS, KC_LALT, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_mins, KC_LEFT, KC_DOWN, KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  _______, _______,   NO_AT,  NO_PND, NO_DLR,  _______, _______, NO_LCBR, NO_LBRC, NO_RBRC, NO_RCBR, KC_DEL,  \
  _______, _______, KC_VOLU, _______, _______, _______, _______, _______, _______, NO_PLUS, KC_PSCREEN, NO_QUOT, \
  _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______, _______, _______, _______, _______, _______, NO_APOS, \
  _______, _______, KC_VOLD, _______, _______, _______, _______, _______, _______, _______, KC_PGUP, _______, \
  _______, _______, NO_PIPE, _______, _______, _______, KC_BSPC, _______, _______, _______, KC_PGDN, _______  \
),,
...
[_RAISE] = LAYOUT_preonic_grid( \
  _______, LSFT(KC_1), NO_QUO2, LSFT(KC_3), NO_BULT, LSFT(KC_5), NO_AMPR, NO_SLSH, NO_LPRN, NO_RPRN, NO_EQL, KC_INS, \
  _______, _______, KC_MS_U, _______, _______, _______, _______, KC_WH_U, _______, NO_QUES, _______, NO_CIRC, \
  _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, KC_BTN1, KC_BTN3, KC_BTN2, _______, _______, LSFT(KC_BSLS), \
  _______, _______, _______, _______, _______, _______, _______, KC_WH_D, NO_COLN, NO_SCLN, KC_PGUP, _______, \
  _______, _______, NO_GRTR, _______, _______, KC_BSPC, _______, _______, NO_UNDS, _______, KC_PGDN, _______  \
),
...
[_ADJUST] = LAYOUT_preonic_grid( \
  ...
  _______, _______, _______, RESET,   _______, _______, _______, _______, _______, NO_BSLS, _______, NO_TILD, \
